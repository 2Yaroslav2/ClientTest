...
import {AdminGoodsDescriptionComponent} from "./admin-goods-description.component";
...
@NgModule({
  declarations: [
    AdminGoodsDescriptionComponent,
    AddGoodsDescriptionComponent,
    EditGoodsDescriptionComponent
  ],
  imports: [
    BrowserModule,
    FormsModule,
...
export class AdminGoodsDescriptionModule { }
